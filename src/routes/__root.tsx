...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Clear AI Agents — Six AI brains for real work" },
      { name: "description", content: "A multi-model AI workspace for coding, writing, research, large documents, screenshots, and productivity." },
      { name: "author", content: "Clear AI Agents" },
      { property: "og:title", content: "Clear AI Agents — Six AI brains for real work" },
      { property: "og:description", content: "Six specialized AI brains in one clean workspace for real work." },
