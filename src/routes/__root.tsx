...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Clear AI" },
      { property: "og:title", content: "Clear AI — The AI that actually answers" },
      { property: "og:description", content: "Unrestricted reasoning. 256K context. No lectures. No refusals." },
...
posthog.init('${posthogKey}', {api_host:'${posthogHost}', capture_pageview:true, capture_pageleave:true, debug:true});`,
            }}
          />
        )}
      </head>
